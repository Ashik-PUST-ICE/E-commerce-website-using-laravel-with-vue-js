						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									...
									{{-- <div class="d-grid">
										<a class="my-4 shadow-sm btn btn-white" href="javascript:;"> <span class="d-flex justify-content-center align-items-center">
                          ...
                          <span>Sign in with Google</span>
									...
									<div class="form-body" id="formSubmit">
                                        @csrf
										<form class="row g-3">
											<div class="col-12">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" name="password" class="form-control border-end-0" id="inputChoosePassword"  placeholder="Enter Password" required> <a href="javascript:;" class="bg-transparent input-group-text"><i class='bx bx-hide'></i></a>
												</div>
											</div>
											<div class="col-md-6">
